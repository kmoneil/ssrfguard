...
surfaces are built: :class:`ssrfguard.httpx.Client`, :class:`ssrfguard.httpx.AsyncClient` and
:class:`ssrfguard.requests.Session`. Start with a client; the pieces below are
